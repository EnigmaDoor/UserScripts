...
// @version      0.1.0
// @description  MidenQuest Script - Dark Theme
// @author       SyntacticSaIt
// @updateURL    https://raw.githubusercontent.com/SyntacticSaIt/MidenQuest_UserScripts/master/MidenQuest.style.DarkTheme.js
...
// ==/UserScript==
// Thanks to Vibblez for the base script, I only added my edits =) https://raw.githubusercontent.com/Vibblez/MidenQuest/master/MidenQuest.Style.Dark.user.js
(function() {
    ...
    addGlobalStyle('#TitleEmbedded { padding-top: 4px; color: #fff !important; border-bottom: #000 2px solid;  }');
    ...
    addGlobalStyle('.prgactionwrapper > #prgactiontimer > .ui-widget-header { border: 1px solid #111; background: #646464; color: #333333; }');
	  addGlobalStyle('.prgactionoverlay { margin-top: -20px !important; color: #f00 !important; }');
	...
	addGlobalStyle('#ChatLog > div, #ChatLog > div > span #ChatLog div:nth-of-type(odd) { background-color: #222; display: inline-block; width: 100%; padding-top: 3px;padding-bottom: 3px;}');
	addGlobalStyle('#ChatLog > div, #ChatLog > div > span #ChatLog div:nth-of-type(even) { display: inline-block; width: 100%; padding-top: 3px; padding-bottom: 3px;}');
