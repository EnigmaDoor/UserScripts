...
// @version      0.0.1
// @description  MidenQuest Script - Custom NavBar with various shortcuts
// @author       SyntacticSaIt
// @updateURL	 https://raw.githubusercontent.com/SyntacticSaIt/MidenQuest_UserScripts/master/MidenQuest.ui.customNavbar.js
// @require      https://ajax.googleapis.com/ajax/libs/jquery/2.2.2/jquery.min.js
// @include      http://www.midenquest.com/Game.aspx
// @include      http://midenquest.com/Game.aspx
// @grant        GM_xmlhttpRequest
// ==/UserScript==
// Thanks Vibblez for the initial Custom Navbar =) https://raw.githubusercontent.com/Vibblez/MidenQuest/master/MidenQuest.CustomNavbar.user.js
    ...
    $("#TitleEmbedded").html('\
             <div class=\"drop\">\
				<ul class="drop_menu">\
					<li>\
								<li>\
                  <a href="#" onclick="sendRequestContentFill(\'getSearch.aspx?null=\')">Tile</a>\
                </li>\
								<li>\
                  <a href="#" onclick="sendRequestContentFill(\'getTradeskill.aspx?w=1&null=\')">Scout</a>\
                </li>\
								<li>\
                  ...
                  <a href="#" onclick="sendRequestContentFill(\'getExpedition.aspx?null=\')">Inn</a>\
								...
								<li>\
                  <a href="#" onclick="sendRequestContentFill(\'getCustomize.aspx?null=\')">Item</a>\
								</li>\
					</li>\
					<li>\
						<a href="#">Misc</a>\
